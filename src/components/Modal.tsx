...
function Modal({ setOpenModal, addWorkoutToday, date }: IModal) {
  const [categoryName, setCategoryName] =
    React.useState<ArrayObjectSelectCategoryName>({
      selectedCategoryName: null,
    });
  const [workoutName, setWorkoutName] =
    React.useState<ArrayObjectSelectWorkoutName>({
        ...
        <div className="modalWorkoutInfo">
          <div className="Info">
            ...
            <Select
              ...
              getOptionValue={(categoryName: CategoryName) =>
                categoryName.category
              }
          ...
          <div className="Info">
            ...
            <input
              ...
              onChange={(e: ChangeEvent<HTMLInputElement>) =>
                setSets(e.target.valueAsNumber)
              }
              value={sets ?? ""}
